...
template class ArrowLocalVertexMap<int64_t, uint64_t>;

template class ArrowLocalVertexMapBuilder<int64_t, uint64_t>;

template Status
ArrowLocalVertexMapBuilder<int64_t, uint64_t>::AddOuterVerticesMapping<int64_t>(
    std::vector<std::vector<std::shared_ptr<ArrowArrayType<int64_t>>>> oids,
...
template Status
ArrowLocalVertexMapBuilder<int64_t, uint32_t>::AddOuterVerticesMapping<int64_t>(
    std::vector<std::vector<std::shared_ptr<ArrowArrayType<int64_t>>>> oids,
