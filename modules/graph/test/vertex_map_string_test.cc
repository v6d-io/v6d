...
int main(int argc, char** argv) {
  if (argc < 5) {
    printf(
        "usage: ./string_vertex_map_test <ipc_socket> "
  ...
  vineyard::ObjectID vm_id;
  {
    ...
    BasicArrowVertexMapBuilder<arrow_string_view, uint64_t> vm_builder(
  ...
  auto vm_ptr =
      std::dynamic_pointer_cast<ArrowVertexMap<arrow_string_view, uint64_t>>(
  ...
  LOG(INFO) << "Passed arrow vertex map with string oid test...";
