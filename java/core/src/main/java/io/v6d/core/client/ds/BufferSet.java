...
public class BufferSet {
    ...
    public void emplace(ObjectID id) throws VineyardException {
        if (this.buffers.getOrDefault(id, null) != null) {
            throw new VineyardException.Invalid("Invalid internal state: the buffer shouldn't has been filled, id = " + id);
        }
        buffer_ids.add(id);
        buffers.put(id, null);
    }
    ...
    public void emplace(ObjectID id, Buffer buffer) throws VineyardException {
        if (!this.buffers.containsKey(id)) {
            throw new VineyardException.Invalid("Invalid internal state: no such buffer defined, id = " + id);
        }
        if (this.buffers.get(id) != null) {
            throw new VineyardException.Invalid("Invalid internal state: duplicated buffer, id = " + id);
        }
