...
@FFITypeAlias("arrow::Time32Type")
@FFIGen
@CXXHead(
        system = "arrow/type.h"
)
public interface Time32Type extends TimeType, FFIPointer {
    int bit_width();
    ...
    static Time32Type cast(final long __foreign_address) {
        try {
            Class<Time32Type> clz = (Class<Time32Type>) FFITypeFactory.getType(FFITypeFactory.getFFITypeName(Time32Type.class, true));
    ...
    static Time32Type cast(final FFIPointer __foreign_pointer) {
        return Time32Type.cast(__foreign_pointer.getAddress());
    }

    static Factory getFactory() {
        return FFITypeFactory.getFactory(FFITypeFactory.getFFITypeName(Time32Type.class, true));
    }

    static Time32Type create(@CXXValue @FFITypeAlias("arrow::TimeUnit::type") TimeUnit.type unit) {
        return Time32Type.getFactory().create(unit);
    }
    ...
    interface Factory {
        Time32Type create(@CXXValue @FFITypeAlias("arrow::TimeUnit::type") TimeUnit.type unit);
    }

    @FFIGen
    @FFILibrary(
            value = "arrow::Time32Type",
            namespace = "arrow::Time32Type"
    )
    @CXXHead(
            system = "arrow/type.h"
    )
    ...
    @FFITypeAlias("arrow::Time32Type::PhysicalType")
    @FFIGen
    @CXXHead(
            system = "arrow/type.h"
    )
    ...
    @FFITypeAlias("arrow::Time32Type::c_type")
    @FFIGen
    @CXXHead(
            system = "arrow/type.h"
    )
    interface c_type extends CXXPointer {
        ...
        @FFIExpr("*{0} = (arrow::Time32Type::c_type){1}")
