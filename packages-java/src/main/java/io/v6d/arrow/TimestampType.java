...
@FFITypeAlias("arrow::TimestampType")
@FFIGen
@CXXHead(
        system = "arrow/type.h"
)
public interface TimestampType extends TemporalType, ParametricType, FFIPointer {
    int bit_width();
    ...
    static TimestampType cast(final long __foreign_address) {
        try {
            Class<TimestampType> clz = (Class<TimestampType>) FFITypeFactory.getType(FFITypeFactory.getFFITypeName(TimestampType.class, true));
    ...
    static TimestampType cast(final FFIPointer __foreign_pointer) {
        return TimestampType.cast(__foreign_pointer.getAddress());
    }

    static Factory getFactory() {
        return FFITypeFactory.getFactory(FFITypeFactory.getFFITypeName(TimestampType.class, true));
    }

    static TimestampType create(
            @CXXValue @FFITypeAlias("arrow::TimeUnit::type") TimeUnit.type unit) {
        return TimestampType.getFactory().create(unit);
    }

    static TimestampType create(@CXXValue @FFITypeAlias("arrow::TimeUnit::type") TimeUnit.type unit,
            @CXXReference string timezone) {
        return TimestampType.getFactory().create(unit, timezone);
    }
    ...
    interface Factory {
        TimestampType create(@CXXValue @FFITypeAlias("arrow::TimeUnit::type") TimeUnit.type unit);
    ...
    @FFIGen
    @FFILibrary(
            value = "arrow::TimestampType",
            namespace = "arrow::TimestampType"
    )
    @CXXHead(
            system = "arrow/type.h"
    )
    ...
    @FFITypeAlias("arrow::TimestampType::Unit")
    @FFIGen
    @CXXHead(
            system = "arrow/type.h"
    )
    ...
    @FFITypeAlias("arrow::TimestampType::PhysicalType")
    @FFIGen
    @CXXHead(
            system = "arrow/type.h"
    )
    ...
    @FFITypeAlias("arrow::TimestampType::c_type")
    @FFIGen
    @CXXHead(
            system = "arrow/type.h"
    )
    interface c_type extends CXXPointer {
        ...
        @FFIExpr("*{0} = (arrow::TimestampType::c_type){1}")
