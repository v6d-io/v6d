...
@FFITypeAlias("arrow::UnionMode")
@FFIGen
@CXXHead(
        system = "arrow/type_fwd.h"
)
public interface UnionMode extends FFIPointer {
    static UnionMode cast(final long __foreign_address) {
        try {
            Class<UnionMode> clz = (Class<UnionMode>) FFITypeFactory.getType(FFITypeFactory.getFFITypeName(UnionMode.class, true));
    ...
    static UnionMode cast(final FFIPointer __foreign_pointer) {
        return UnionMode.cast(__foreign_pointer.getAddress());
    }

    @FFITypeAlias("arrow::UnionMode::type")
    @FFITypeRefiner("io.v6d.arrow.UnionMode.type.get")
    @CXXHead(
            system = "arrow/type_fwd.h"
    )
    enum type implements CXXEnum {
        SPARSE(Library.INSTANCE.SPARSE()),

        DENSE(Library.INSTANCE.DENSE());
        ...
        @FFIGen
        @FFILibrary(
                value = "arrow::UnionMode::type",
                namespace = "arrow::UnionMode::type"
        )
        @CXXHead(
                system = "arrow/type_fwd.h"
        )
