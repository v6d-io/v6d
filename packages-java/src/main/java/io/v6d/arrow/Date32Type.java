...
@FFITypeAlias("arrow::Date32Type")
@FFIGen
@CXXHead(
        system = "arrow/type.h"
)
public interface Date32Type extends DateType, FFIPointer {
    int bit_width();
    ...
    static Date32Type cast(final long __foreign_address) {
        try {
            Class<Date32Type> clz = (Class<Date32Type>) FFITypeFactory.getType(FFITypeFactory.getFFITypeName(Date32Type.class, true));
    ...
    static Date32Type cast(final FFIPointer __foreign_pointer) {
        return Date32Type.cast(__foreign_pointer.getAddress());
    }

    static Factory getFactory() {
        return FFITypeFactory.getFactory(FFITypeFactory.getFFITypeName(Date32Type.class, true));
    }

    static Date32Type create() {
        return Date32Type.getFactory().create();
    }
    ...
    @FFIGen
    @FFILibrary(
            value = "arrow::Date32Type",
            namespace = "arrow::Date32Type"
    )
    @CXXHead(
            system = "arrow/type.h"
    )
    ...
    @FFITypeAlias("arrow::Date32Type::c_type")
    @FFIGen
    @CXXHead(
            system = "arrow/type.h"
    )
    interface c_type extends CXXPointer {
        ...
        @FFIExpr("*{0} = (arrow::Date32Type::c_type){1}")
    ...
    @FFITypeAlias("arrow::Date32Type::PhysicalType")
    @FFIGen
    @CXXHead(
            system = "arrow/type.h"
    )
