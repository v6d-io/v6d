...
import io.v6d.std.impl.allocator_traits.SizeTypeStdAllocatorStdSharedPtrArrowField;
...
@FFITypeAlias("std::__vector_base<std::shared_ptr<arrow::Field>, std::allocator<std::shared_ptr<arrow::Field>>>::size_type")
@FFIGen
@CXXHead(
        system = "vector"
)
public interface SizeTypeStdSharedPtrArrowFieldStdAllocatorStdSharedPtrArrowField extends CXXPointer {
    @FFIExpr("{0}")
    SizeTypeStdAllocatorStdSharedPtrArrowField get();
