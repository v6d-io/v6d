...
import io.v6d.arrow.ArrayVisitor;
...
@FFITypeAlias("std::shared_ptr<arrow::Array>::element_type")
@FFIGen
@CXXHead(
        system = "__memory/shared_ptr.h"
)
public interface ElementTypeArrowArray extends CXXPointer {
    @FFIExpr("{0}")
    Array get();
    ...
    static ElementTypeArrowArray cast(final long __foreign_address) {
        try {
            Class<ElementTypeArrowArray> clz = (Class<ElementTypeArrowArray>) FFITypeFactory.getType(FFITypeFactory.getFFITypeName(ElementTypeArrowArray.class, true));
    ...
    static ElementTypeArrowArray cast(final FFIPointer __foreign_pointer) {
        return ElementTypeArrowArray.cast(__foreign_pointer.getAddress());
    }
}
