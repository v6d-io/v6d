...
@FFITypeAlias("vineyard::FixedSizeBinaryArray")
@FFIGen
@CXXHead("basic/ds/arrow.vineyard.h")
public interface FixedSizeBinaryArray extends PrimitiveArray, Registered<FixedSizeBinaryArray>, FFIPointer {
    ...
    shared_ptr<io.v6d.arrow.FixedSizeBinaryArray> GetArray();
    ...
    @FFIGen
    @FFILibrary(
            value = "vineyard::FixedSizeBinaryArray",
            namespace = "vineyard::FixedSizeBinaryArray"
    )
    @CXXHead("basic/ds/arrow.vineyard.h")
    interface Library {
