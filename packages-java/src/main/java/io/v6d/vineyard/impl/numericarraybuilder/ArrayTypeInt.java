...
@FFITypeAlias("vineyard::NumericArrayBuilder<int>::ArrayType")
@FFIGen
@CXXHead("basic/ds/arrow.h")
public interface ArrayTypeInt extends CXXPointer {
    @FFIExpr("{0}")
    io.v6d.vineyard.impl.converttoarrowtype.ArrayTypeInt get();
    ...
    static ArrayTypeInt create(
            ...
            long arg4, long arg5) {
        return ArrayTypeInt.getFactory().create(arg0, arg1, arg2, arg3, arg4, arg5);
    }
