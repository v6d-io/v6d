...
import io.v6d.arrow.Date64Builder;
...
@FFITypeAlias("vineyard::ConvertToArrowType<arrow::Date64Type>::BuilderType")
@FFIGen
@CXXHead("basic/ds/arrow_utils.h")
public interface BuilderTypeArrowDate64Type extends CXXPointer {
    @FFIExpr("{0}")
    Date64Builder get();
    ...
    static BuilderTypeArrowDate64Type cast(final long __foreign_address) {
        try {
            Class<BuilderTypeArrowDate64Type> clz = (Class<BuilderTypeArrowDate64Type>) FFITypeFactory.getType(FFITypeFactory.getFFITypeName(BuilderTypeArrowDate64Type.class, true));
    ...
    static BuilderTypeArrowDate64Type cast(final FFIPointer __foreign_pointer) {
        return BuilderTypeArrowDate64Type.cast(__foreign_pointer.getAddress());
    }

    static Factory getFactory() {
        return FFITypeFactory.getFactory(FFITypeFactory.getFFITypeName(BuilderTypeArrowDate64Type.class, true));
    }

    static BuilderTypeArrowDate64Type create(
            @CXXReference @FFITypeAlias("const std::shared_ptr<arrow::DataType>") shared_ptr<DataType> type,
            MemoryPool pool) {
        return BuilderTypeArrowDate64Type.getFactory().create(type, pool);
    }

    @FFIFactory
    @CXXHead("basic/ds/arrow_utils.h")
    interface Factory {
        BuilderTypeArrowDate64Type create(
                @CXXReference @FFITypeAlias("const std::shared_ptr<arrow::DataType>") shared_ptr<DataType> type,
                MemoryPool pool);
    }
}
