...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VineyarddConfig) DeepCopyInto(out *VineyarddConfig) {
	*out = *in
	in.SpillConfig.DeepCopyInto(&out.SpillConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VineyarddConfig.
func (in *VineyarddConfig) DeepCopy() *VineyarddConfig {
	if in == nil {
		return nil
	}
	out := new(VineyarddConfig)
	in.DeepCopyInto(out)
	return out
}
