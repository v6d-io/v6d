...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VineyardJob) DeepCopyInto(out *VineyardJob) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VineyardJob.
func (in *VineyardJob) DeepCopy() *VineyardJob {
	if in == nil {
		return nil
	}
	out := new(VineyardJob)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VineyardJob) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VineyardJobList) DeepCopyInto(out *VineyardJobList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]VineyardJob, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VineyardJobList.
func (in *VineyardJobList) DeepCopy() *VineyardJobList {
	if in == nil {
		return nil
	}
	out := new(VineyardJobList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VineyardJobList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VineyardJobSpec) DeepCopyInto(out *VineyardJobSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VineyardJobSpec.
func (in *VineyardJobSpec) DeepCopy() *VineyardJobSpec {
	if in == nil {
		return nil
	}
	out := new(VineyardJobSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VineyardJobStatus) DeepCopyInto(out *VineyardJobStatus) {
	*out = *in
	if in.Hosts != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VineyardJobStatus.
func (in *VineyardJobStatus) DeepCopy() *VineyardJobStatus {
	if in == nil {
		return nil
	}
	out := new(VineyardJobStatus)
	in.DeepCopyInto(out)
	return out
}
