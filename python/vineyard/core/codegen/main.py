...
from .parsing import parse_deps, parse_module
...
def parse_sys_args():
    ...
    arg_parser.add_argument('-I',
                            ...
                            default='',
                            help='Directories that will been included in CMakeLists.txt')
    arg_parser.add_argument('-l', '--langauge', type=str, default='cpp', help="Language interfaces to generate")
...
def main():
    ...
    if args.dump_dependencies:
        ...
        codegen(args.root_directory, args.langauge, args.source, args.target, args.system_includes, args.includes,
                args.extra_flags, args.build_directory, args.verbose)
