...
def test_pandas_dataframe(vineyard_client, request):
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_pandas_dataframe_string(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
    # see gh#533
    df = pd.DataFrame({'a': ['1', '2', '3', '4'], 'b': ['5', '6', '7', '8']})
    object_id = vineyard_client.put(df)
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_pandas_dataframe_complex_columns(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
    # see gh#533
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_pandas_dataframe_int_columns(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_pandas_dataframe_mixed_columns(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
    df = pd.DataFrame(
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_dataframe_reindex(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_dataframe_set_index(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
    df1 = pd.DataFrame(
        [[1, 3, 3], [4, 2, 6], [7, 8, 9]],
        index=['a1', 'a2', 'a3'],
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_sparse_array(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_dataframe_with_sparse_array(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_dataframe_with_sparse_array_int_columns(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_dataframe_with_sparse_array_mixed_columns(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_dataframe_with_datetime(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
    # GH-575
    dates = [
...
@pytest.mark.parametrize("vineyard_client", ['vineyard_client', 'vineyard_rpc_client'])
def test_dataframe_with_multidimensional(vineyard_client, request):
    vineyard_client = request.getfixturevalue(vineyard_client)
    df = pd.DataFrame(
        {
