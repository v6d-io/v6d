...
# vineyard_benchmark documentation build
...
from vineyard_benchmark import __version__ as release

# -- Project information -----------------------------------------------------

project = "vineyard_benchmark"
author = "Kedro"
...
htmlhelp_basename = "vineyard_benchmarkdoc"
...
latex_documents = [
    (
        master_doc,
        "vineyard_benchmark.tex",
        "vineyard_benchmark Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "vineyard_benchmark",
        "Project vineyard_benchmark codebase.",
        "Data-Science",
    )
]
